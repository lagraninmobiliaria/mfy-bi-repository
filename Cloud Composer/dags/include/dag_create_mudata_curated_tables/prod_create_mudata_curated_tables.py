...
from dependencies.keys_and_constants import PROJECT_ID, PROD_DATASET_MUDATA_CURATED
...
with DAG(
    dag_id= "prod_create_mudata_curated_tables",
    ...
    params= {
        ...
        'mudata_raw': PROD_DATASET_MUDATA_CURATED
    }
) as dag:
